...
@Component({
  selector: 'app-home',
  templateUrl: './driver-sign.component.html',
  styleUrls: ['./driver-sign.component.scss']
})
export class DriverSignComponent implements OnInit {

  constructor(private remult: Remult, private dialog: UIToolsService, private route: ActivatedRoute) { }
  x = '';
